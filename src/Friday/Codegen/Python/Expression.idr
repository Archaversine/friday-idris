module Friday.Codegen.Python.Expression
...
export
inParens : PyGen a -> PyGen a 
inParens g = generate "(" *> g <* generate ")"

mutual
    export
    genFuncArgs : List Expr -> PyGen () 
    genFuncArgs []               = pure ()
    ...
    genExpr (TerenaryExpr x y z)  = inParens (genExpr y *> generate " if " *> genExpr x *> generate " else " *> genExpr z)
